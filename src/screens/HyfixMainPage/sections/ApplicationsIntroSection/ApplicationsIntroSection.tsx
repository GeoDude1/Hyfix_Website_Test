  ...
  return (
    <section className="w-full py-12 px-4">
      <div className="max-w-6xl mx-auto text-center space-y-4">
        ...
        <p className={`[font-family:'Hind',Helvetica] font-normal text-[#030303] text-xl md:text-2xl tracking-[0] leading-normal max-w-6xl mx-auto ${inView ? "animate-fade-in opacity-100 translate-y-0 [--animation-delay:200ms]" : "translate-y-[-1rem] opacity-0"}`}>
